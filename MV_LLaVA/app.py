...
"""
title_markdown = ("""
# [MV-LLAVA Demo] (Bootstrap3D: Improving 3D Content Creation with Synthetic Data)
...
### Squared Four View Image ONLY as Input!
""")
tos_markdown = ("""
### Terms of use
...
def split_four(image):
    if image.size[0] != image.size[1]:
        raise ValueError(
                        "Number of images does not match number of <image> tokens in prompt")
    full_size = image.size[0]
    half_size = image.size[0] // 2
    v1, v2, v3, v4 = image.crop((0, 0, half_size, half_size)), \
                     image.crop((half_size, 0, full_size, half_size)), \
                     image.crop((0, half_size, half_size, full_size)), \
...
def build_demo():
    ...
    with gr.Blocks(title="MV-LLaVA", theme=gr.themes.Default(), css=block_css) as demo:
        state = gr.State()
        ...
        with gr.Row():
            with gr.Column(scale=5):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/examples/objaverse.png",
                        "Describe the following multi-view image as detailed as possible."],
                    [f"{cur_dir}/examples/sv3d.jpg",
                        "What do you think about the overall quality of view consistency of three synthesized novel views?"],
            ...
            with gr.Column(scale=8):
                chatbot = gr.Chatbot(
                    elem_id="chatbot", label="MV-LLaVA Chatbot", height=550)
                with gr.Row():
                    with gr.Column(scale=8):
                        textbox.render()
