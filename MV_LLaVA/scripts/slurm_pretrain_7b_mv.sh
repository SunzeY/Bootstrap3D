...
export DATA_PATH=data/share4v_pretrain_multi_1246k.json
...
export SAVE_PATH=mv_vc_zpp_share4v-7b_pretrained_pt-1.0m_ft-vit-l4-mlp-llm-lr-2e-5
export TUNE_ENTIRE_MODEL=true
export TUNE_VIT_FROM=20 # no layer to be finetuned
export BASE_LR=2e-5
